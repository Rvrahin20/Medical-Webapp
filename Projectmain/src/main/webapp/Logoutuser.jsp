...
<a href="Userlogin.jsp"><button type="button" style="margin-top: 250px;margin-left:700px;width:200px; height:50px; font-size: 15px;"  background-color:skyblue>Back to login/Logout</button></a>
