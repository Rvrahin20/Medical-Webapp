...
<h1 align="center">MEDICAL CONDITION IMAGE SEARCH AND VIEWER</h1><br><br><br>
<h2 align="center" style="color:blue;font-family:verdana;">Request Sended...</h2>
<a href="Homeuser.jsp"><button type="button" style="margin-top: 250px;margin-left:650px;width:200px; height:50px; font-size: 15px;"  background-color:skyblue>Back to Homepage</button></a>
