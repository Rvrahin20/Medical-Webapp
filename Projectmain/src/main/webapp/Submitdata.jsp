...
<form action="UploadServ" method="post" style="margin-left:100px;" enctype="multipart/form-data"><br><br>

&emsp;&nbsp;&emsp;&nbsp;&emsp;&nbsp;&emsp;&nbsp;
<label for="iname"><b>Owner Name</b></label>&emsp;&nbsp;
<input type="text" name="iname">&emsp;&emsp;<br><br>

<label for="imgname"><b>Name</b></label>&emsp;&nbsp;
<input type="text" name="imgname">&emsp;&emsp;
    
<label for="image"><b>Image File</b></label>   
<input type="file" name="image"><br><br><br>
    
<label for="key"><b>Keyword</b></label>    
<input type="text" required name="key" >&emsp;&emsp;

<label for="des"><b>Description</b></label>
<input type="text" name="des" style="width:250px; height:150px; margin-top:5px;margin-right: -20px">

<br><br>
<input type="hidden" name="action" value="submit"><br><br>
<input type="submit" style="margin-left:100px;">&nbsp;&nbsp;&emsp;
