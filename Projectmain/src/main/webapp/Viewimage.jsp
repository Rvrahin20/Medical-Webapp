  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"  style="border: 2px solid black; width: 300px; background-color:lightgrey;;">
          <a class="nav-link" href="Submitdata.jsp" style="margin-top:15px;"><b>Submit Data</b></a>
        </li>
...
<tr>
<th>SI No</th>  
<th>Details of Uploaded Image</th>
<th>Image</th>
</tr>
...
<tr>
<td> <%=robj.getFid()%> </td>
<td><b><%=robj.getDes() %></b><br>Decryption Key-<%=robj.getKey() %></td><br>
<td><img src= "<%=robj.getImgname()%>" width="600px" height="600px"></td>
